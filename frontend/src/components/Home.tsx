...
export default function Home() {
  ...
  useEffect(() => {
    ...
    canvas.width = W * PX
    canvas.height = H * PX
    // Delhi skyline pixel art — buildings from left to right
    // Each building: [startX%, width%, height%, color]
    const buildings = [
      // Qutub Minar style tower (far left)
      { x: 2, w: 3, h: 55, color: "#c87941" },
      { x: 2, w: 3, h: 2, color: "#e8a060", top: true },
      // Low building
      { x: 6, w: 6, h: 28, color: "#1a2a4a" },
      // India Gate arch shape
